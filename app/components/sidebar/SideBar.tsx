    ...
    <div className="px-6 py-4 w-1/5 h-full  border-r flex flex-col justify-between   border-[#EAEAEA] ">
      <div className="flex flex-col gap-2">
        <Tab
          tabText="Home"
          isSelected={false}
          icon={<Image src={Home.src} width={20} height={20} alt="Home Icon" />}
          onClick={() => {
            handleTabClick("Home");
          }}
        ></Tab>
        <Tab
          ...
          isSelected={false}
          icon={
            <Image src={Store.src} width={20} height={20} alt="Home Icon" />
          }
          onClick={() => {
            handleTabClick("Store");
          }}
        ></Tab>
        <Tab
          tabText="Profile"
        ...
        <Tab
          ...
          isSelected={false}
          icon={
            <Image src={Settings.src} width={20} height={20} alt="Home Icon" />
          }
          onClick={() => {
